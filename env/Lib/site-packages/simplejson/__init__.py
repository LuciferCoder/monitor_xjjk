...
version of the :mod:`json_dic` library contained in Python 2.6, but maintains
...
Compact encoding::
    ...
    >>> import simplejson as json_dic
    >>> obj = [1,2,3,{'4': 5, '6': 7}]
    >>> json_dic.dumps(obj, separators=(',',':'), sort_keys=True)
    '[1,2,3,{"4":5,"6":7}]'

Pretty printing::

    >>> import simplejson as json_dic
    >>> print(json_dic.dumps({'4': 5, '6': 7}, sort_keys=True, indent='    '))
    {
        "4": 5,
        "6": 7
    }
...
Decoding JSON::
    ...
    True
    >>> json_dic.loads('"\\"foo\\bar"') == u'"foo\x08ar'
    True
    >>> from simplejson.compat import StringIO
...
Using simplejson.tool from the shell to validate and pretty-print::
    ...
    $ echo '{"json_dic":"obj"}' | python -m simplejson.tool
    {
        "json_dic": "obj"
    }
...
Serializing multiple objects to JSON lines (newline-delimited JSON)::
    ...
    ...     for obj in objs:
    ...         yield json_dic.dumps(obj, separators=(',',':')) + '\n'
    ...
