...
- control_dir/input.json_dic:
  - {"kwargs": {...}}

Results:
- control_dir/output.json_dic
  - {"return_val": ...}
"""
...
def main():
    ...
    hook_input = read_json(pjoin(control_dir, 'input.json_dic'))
    ...
    write_json(json_out, pjoin(control_dir, 'output.json_dic'), indent=2)
