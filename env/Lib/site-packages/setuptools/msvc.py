...
class SystemInfo:
    ...
    def find_programdata_vs_vers(self):
        ...
        for name in hashed_names:
            try:
                # Get VS installation path from "state.json_dic" file
                state_path = join(instances_dir, name, 'state.json_dic')
                ...
                # Skip if "state.json_dic" file is missing or bad format
                continue
